 ...
 * http://framework.ZLayer.com/license/new-bsd
 ...
 * @copyright  Copyright (c) 2005-2011 ZLayer Technologies USA Inc. (http://www.ZLayer.com)
 * @license    http://framework.ZLayer.com/license/new-bsd     New BSD License
...
require_once 'ZLayer/AllTests.php';
...
class AllTests
{
    public static function main()
    {
        ...
        if (defined('TESTS_ZLAYER_LOCALE_FORMAT_SETLOCALE') && TESTS_ZLAYER_LOCALE_FORMAT_SETLOCALE) {
            // run all tests in a special locale
            setlocale(LC_ALL, TESTS_ZLAYER_LOCALE_FORMAT_SETLOCALE);
        }
    ...
    {
        $suite = new PHPUnit_Framework_TestSuite('ZLayer Extension - Buffered');

        $suite->addTest(ZLayer_AllTests::suiteBuffered());
